...
//!
//! NOTE: hand-augmented with the `matched_name` column (added in
//! `m20260428_120400_add_matched_name_to_signature_metadata_mapping`). If
//! sea-orm-codegen is rerun against the schema, that field must be reapplied.
